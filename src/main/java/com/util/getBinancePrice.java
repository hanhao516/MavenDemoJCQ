...
public class getBinancePrice {

    public static String getPriceUsdt(String excoin)
    {
        String remoURL = "http://47.52.137.185:8088/test/binance/hello";
        Map<String,String> paraMap = new HashMap<String, String>();
        paraMap.put("hiBitch8","skjdf8234j2l34uj8dfu79283423rkj");
        paraMap.put("symbol",excoin.toUpperCase()+"USDT");
...
//            JSONObject dataObj = JSONObject.parseObject(dataJ);
            String highM = jsonObject.get("highPrice").toString();
            String lowM = jsonObject.get("lowPrice").toString();
            String closeM = jsonObject.get("askPrice").toString();
            String returnStr = excoin + "(Binance)现价: " + get2PointUtil(closeM) +"$\n"+
